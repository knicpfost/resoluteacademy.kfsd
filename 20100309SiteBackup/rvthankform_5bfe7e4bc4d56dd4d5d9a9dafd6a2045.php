...
<link rel="stylesheet" href="http://resoluteacademy.com/a1aac298c3ab942758645e3263d79b4d.css" type="text/css" />
									...
									<tr>
										<td class="magin">
											<table cellpadding="0" cellspacing="0" width="100%">
												<tr>
													<!-- Begin PATHWAY -->
													<td align="left" width="99%"><?php include('/home/resolute/public_html/rvsincludefile/pathway_Contact-Us.html'); ?></td>
													<!-- End PATHWAY -->
													<!-- Begin ICON -->
													<td align="right"><?php include('/home/resolute/public_html/rvsincludefile/icon_Contact-Us.html'); ?></td>
													<!-- End ICON -->
												</tr>
											</table>								
										</td>
...
$RVS_LANG  = "english-iso-8859-15";
require_once "scripts/form/thankform.php";
 ?>
</td>
