...
(function(jQuery) {
	...
	this.each(function() {
		...
		function current(t) {
			...
			/* based on info found here: https://wordpress.org/support/topic/slider-issue-with-photoria-jquery-error
			add this to the growing list of reasons to hate WordPress and jQuery */
