...
?>
    ...
    <link rel="stylesheet" media="screen" href="<?php echo $wp_url?>/wp-content/plugins/paypal_payment_terminal/resources/css/ui-lightness/jquery-ui-1.7.3.custom.css" />
    <script type="text/javascript" src="<?php echo $wp_url?>/wp-content/plugins/paypal_payment_terminal/resources/js/ui.datepicker.js"></script>
    <script>
	$(function() {
		...
		<div class="wrap">
			<?php    echo "<h2>" . __('PayPal Payment Terminal Transactions','') . "</h2>"; ?>
